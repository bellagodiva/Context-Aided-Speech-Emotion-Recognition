...
from src import a_raw_train
from src.a_raw_dataset import Multimodal_Datasets, compute_metrics, get_num_classes
...
parser.add_argument('--num_past_utterances', type=int, default=30,
                    help='roberta speaker name in capital')
...
train_path = os.path.join(args.root_dir, args.dataset) + 'train_hubemoberta_30past.dt'
valid_path = os.path.join(args.root_dir, args.dataset) + 'valid_hubemoberta_30past.dt'
test_path = os.path.join(args.root_dir, args.dataset) + 'test_hubemoberta_30past.dt'
...
if __name__ == '__main__':
    test_loss = a_raw_train.initiate(hyp_params, train_loader, valid_loader, test_loader)
