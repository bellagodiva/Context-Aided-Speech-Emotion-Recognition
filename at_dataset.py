    ...
    def _create_input(
        ...
        for diaid in tqdm(diaids):
            ...
            for idx, ue in enumerate(ues):
                ...
                if not os.path.exists('/mnt/hard2/bella/IEMOCAP/audio_covarep/'+uttids[idx]+'.mat'):
                    continue
                ...
                audio_covarep = scipy.io.loadmat('/mnt/hard2/bella/IEMOCAP/audio_covarep/'+uttids[idx]+'.mat')['features']

                #inputs.append(input_)
                inputs.append({"text": text_input, "audio":audio_covarep, "label":label})
